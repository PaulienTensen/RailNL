...
# Case: Rail NL
#
# Functies die angeroepen worden in het verderzoekalgoritme.
#
...
def pop(trajecten_algemeen, oud_trajecten_algemeen, sporen, traject):
    ...
    """
        ...
        # Voorkomt dat staions verwijdert worden die niet verwijdert moeten worden.
        if len(trajecten_algemeen) == len(oud_trajecten_algemeen):
            trajecten_algemeen = trajecten_algemeen
        else:
            pop2 = trajecten_algemeen.pop()

            # Als laatste station in het traject niet overeenkomt met het gepopte station, moet hij niet verwijdert worden.
            if not pop == pop2:
                trajecten_algemeen.append(pop2)
        
        # Verwijder laatste verbinding uit sporen indien de laatst toegevoegde verbinding boven de 180 mins zit. 
